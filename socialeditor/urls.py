...
urlpatterns = patterns('socialeditor.views',
    ...
    url(r'^(?P<short_name>\w+)/add/(?P<add_short_name>\w+)$', 'add_friend', name="add_friend"),     
    url(r'^(?P<short_name>\w+)/remove/(?P<remove_short_name>\w+)$', 'remove_friend', name="remove_friend"),
