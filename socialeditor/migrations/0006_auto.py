...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ballroom_profile_favorite_routines', (
        ...
        db.create_unique('ballroom_profile_favorite_routines', ['profile_id', 'routine_id'])

        # Adding M2M table for field favorite_figures on 'Profile'
        db.create_table('ballroom_profile_favorite_figures', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['ballroom.profile'], null=False)),
            ('figure', models.ForeignKey(orm['ballroom.figure'], null=False))
        ))
        db.create_unique('ballroom_profile_favorite_figures', ['profile_id', 'figure_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ballroom_profile_favorite_routines')

        # Removing M2M table for field favorite_figures on 'Profile'
        db.delete_table('ballroom_profile_favorite_figures')
    ...
    models = {
        ...
        'ballroom.profile': {
            ...
            'favorite_figures': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['ballroom.Figure']"}),
            'favorite_routines': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'favorited_by'", 'symmetrical': 'False', 'to': "orm['ballroom.Routine']"}),
