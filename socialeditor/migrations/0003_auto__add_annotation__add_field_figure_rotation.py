...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ballroom_annotation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('routine', self.gf('django.db.models.fields.related.ForeignKey')(related_name='annotations', to=orm['ballroom.Routine'])),
        ...
        db.send_create_signal('ballroom', ['Annotation'])

        # Adding field 'Figure.rotation'
        db.add_column('ballroom_figure', 'rotation',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ballroom_annotation')

        # Deleting field 'Figure.rotation'
        db.delete_column('ballroom_figure', 'rotation')
