...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Figure.mirror_figure'
        db.add_column('ballroom_figure', 'mirror_figure',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ballroom.Figure'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Figure.mirror_figure'
        db.delete_column('ballroom_figure', 'mirror_figure_id')
